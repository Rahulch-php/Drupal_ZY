...
class Whois { 
    ...
    private function queryServer(){ 
        $out = ""; 
		//$proxy_server = "https://jboss-stage.jnj.com:433/ProxyServlet?PROXY_URI=";
        $fp = @fsockopen($proxy_server.$this->whoisserver, $this->port, $this->errno, $this->errstr, $this->timeout); 
